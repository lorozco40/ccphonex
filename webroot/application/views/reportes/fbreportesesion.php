<div class="container main">
    ...
    <input type="hidden" name="reporte" value="facebook_sesion"/>
        <div class="container">
            <div class="row">
                <div class="col-md-1">
                    <h1>Facebook&nbsp;sesiones</h1>
                </div>
...
<script src="<?php echo site_url('js/reportes/facebook_sesion.js?v='.time()); ?>" charset="utf-8"></script>
