<div class="container-fluid main">
    <form target="_blank" method="post" class="form" action="<?php echo site_url("reportes/excel"); ?>">
        <input type="hidden" name="reporte" value="sesion" />
...
<script type="text/javascript" src="<?php echo site_url('js/reportes/sesion.js?v='.time()); ?>" charset="utf-8"></script>
