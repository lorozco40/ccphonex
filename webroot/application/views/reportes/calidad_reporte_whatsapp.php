<div class="container-fluid main">
    <form target="_blank" class="form form-inline" action="<?php echo site_url("calidad/excelcalidadwa"); ?>" method="post">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-1">
                    <h1>Calidad&nbsp;whatsapp</h1>
                </div>
        ...
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text">Tipo de Conversación</span>
            </div>
...
<script type="text/javascript" src="<?php echo site_url('js/reportes/calidad_whatsapp.js?v='.time()); ?>" charset="utf-8"></script>
