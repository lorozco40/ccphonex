...
include_once (APPPATH . 'third_party/vendor/phpseclib/Crypt/Base.php');
include_once (APPPATH . 'third_party/vendor/phpseclib/Crypt/Blowfish.php');
include_once (APPPATH . 'third_party/vendor/phpseclib/Crypt/Random.php');
include_once (APPPATH . 'third_party/vendor/phpseclib/Crypt/RC4.php');
include_once (APPPATH . 'third_party/vendor/phpseclib/Crypt/Rijndael.php');
include_once (APPPATH . 'third_party/vendor/phpseclib/Crypt/TripleDES.php');
include_once (APPPATH . 'third_party/vendor/phpseclib/Crypt/Twofish.php');
include_once (APPPATH . 'third_party/vendor/phpseclib/System/SSH/Agent.php');
include_once (APPPATH . 'third_party/vendor/phpseclib/Math/BigInteger.php');
include_once (APPPATH . 'third_party/vendor/phpseclib/Crypt/Hash.php');
include_once (APPPATH . 'third_party/vendor/phpseclib/Crypt/RSA.php');
