...
// which gets the first element for a given key (e.g. Get, Str2Int, or GetBool).
...
// Str2Int returns the first element in data[key] converted to an int.
func (d Data) Str2Int(key string) int {
