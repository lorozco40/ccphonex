<div class="container-fluid main">
    ...
    <input type="hidden" name="reporte" value="twitter_detalle"/>
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-1">
                    <h1>Twitter&nbsp;detalle</h1>
                </div>
...
<script src="<?php echo site_url('js/reportes/twitter_detalle.js?v='.time()); ?>" charset="utf-8"></script>
