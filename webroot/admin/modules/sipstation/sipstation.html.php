...
} elseif ($json_array['query_status'] == 'SUCCESS' && $json_array['version'] >= $sipstation->sipstation_api_version_min && $json_array['version'] <= $sipstation->sipstation_api_version_max) { // TODO: This needs to be checking that there was no failure
...
} elseif ($json_array['query_status'] == 'SUCCESS' && $json_array['version'] > $sipstation->sipstation_api_version_max) {
	$json_array['status'] = sprintf(_("Your module version is not compatible with the current API requirements and needs to be updated. Expecting XML version no greater then %s and received version %s."),$sipstation->sipstation_api_version_max, $json_array['xml_version']);
  unset($json_array['query_status_message']);
  unset($json_array['query_status']);
} else {
