	...
	<td colspan="2">
		<div class="sipstation-errors">
			...
			<ul>
				...
				switch ($status) {
					case 'invalid':
						echo _("Your key is no longer valid. Click below to remove the current key. To obtain a new key and use this module, visit the portal at https://store.freepbx.com and log into your account. After getting your new key please refresh this page to enter it.");
					break;
					case 'tempnotavail':
