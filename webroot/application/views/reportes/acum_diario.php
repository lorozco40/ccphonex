<div class="container-fluid main" id="sla">
    <form id="acumdiarioform" target="_blank" method="post" class="form form-inline" action="<?php echo site_url("sl/excel"); ?>">
    <input type="hidden" name="reporte" value="acumdiario"/>
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-1">
                    <h1>Acumulado&nbsp;diario</h1>
                </div>
    ...
    <div class="row">
        <div class="col" id="acum_diario"></div>
    </div>
    <div class="row">
        <div class="col" id="leyend"></div>
    </div>
</div>
<script type="text/javascript" src="<?php echo site_url('js/reportes/acum_diario.js?v='.time()); ?>" charset="utf-8"></script>
