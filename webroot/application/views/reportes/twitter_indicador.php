<div class="container main" id="twit">
    <form target="_blank" method="post" class="form form-inline" action="<?php echo site_url("twitter/excel"); ?>">
    <input type="hidden" name="reporte" value="twitter_indicador"/>
        <div class="container">
            <div class="row">
                <div class="col-md-1">
                    <h1>Twitter&nbsp;indicadores</h1>
                </div>
    ...
    <div class="row">
        <div class="col" id="twitterind"></div>
    </div>
    <div class="row">
...
<script src="<?php echo site_url('js/reportes/twitter_indicador.js?v='.time()); ?>" charset="utf-8"></script>
