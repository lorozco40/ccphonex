<div class="container main">
    ...
    <p>¡Bienvenido a Assertive Business!</p>
    <p>Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web de Next Generation Teleservices SA de CV, ubicado en https://assertivebusiness.com/.</p>
    <p>Al acceder a este sitio web, asumimos que aceptas estos términos y condiciones. No continúes usando Assertive Business si no estás de acuerdo con todos los términos y condiciones establecidos en esta página.</p>
    <p>Cookies:</p>
    <p>El sitio web utiliza cookies para ayudar a personalizar tu experiencia en línea. Al acceder a Assertive Business, aceptaste utilizar las cookies necesarias.</p>
    ...
    <p>Licencia:</p>
    <p>A menos que se indique lo contrario, Next Generation Teleservices SA de CV y/o sus licenciantes poseen los derechos de propiedad intelectual de todo el material en Assertive Business. Todos los derechos de propiedad intelectual son reservados. Puedes acceder desde Assertive Business para tu uso personal sujeto a las restricciones establecidas en estos términos y condiciones.</p>
    <p>No debes:</p>
    <p>Copiar o volver a publicar material de Assertive Business
    <p>Vender, alquilar o sublicenciar material de Assertive Business</p>
    <p>Reproducir, duplicar o copiar material de Assertive Business</p>
    <p>Redistribuir contenido de Assertive Business</p>
    <p>Este acuerdo comenzará el fecha presente.</p>
    <p>Partes de este sitio web ofrecen a los usuarios la oportunidad de publicar e intercambiar opiniones e información en determinadas áreas. Next Generation Teleservices SA de CV no filtra, edita, publica ni revisa los comentarios antes de su presencia en el sitio web. Los comentarios no reflejan los puntos de vista ni las opiniones de Next Generation Teleservices SA de CV, sus agentes y/o afiliados. Los comentarios reflejan los puntos de vista y opiniones de la persona que publica. En la medida en que lo permitan las leyes aplicables, Next Generation Teleservices SA de CV no será responsable de los comentarios ni de ninguna responsabilidad, daños o gastos causados o sufridos como resultado de cualquier uso o publicación o apariencia de comentarios en este sitio web.</p>
    <p>Next Generation Teleservices SA de CV se reserva el derecho de monitorear todos los comentarios y eliminar los que puedan considerarse inapropiados, ofensivos o que incumplan estos Términos y Condiciones.</p>
    <p>Garantizas y declaras que:</p>
    <p>Tienes derecho a publicar comentarios en nuestro sitio web y tienes todas las licencias y consentimientos necesarios para hacerlo;</p>
    ...
    <p>Los comentarios no contienen ningún material difamatorio, calumnioso, ofensivo, indecente o ilegal de otro modo, que sea una invasión de la privacidad.</p>
    <p>Los comentarios no se utilizarán para solicitar o promover negocios o actividades comerciales personalizadas o presentes o actividades ilegales.</p>
    <p>Por la presente, otorgas a Next Generation Teleservices SA de CV una licencia no exclusiva para usar, reproducir, editar y autorizar a otros a usar, reproducir y editar cualquiera de tus comentarios en todas y cada una de las formas, formatos, o medios.</p>
    <p>Hipervínculos a nuestro contenido:</p>
    ...
    <p>Los distribuidores de directorios en línea pueden vincularse a nuestro sitio web de la misma manera que hacen hipervínculos a los sitios web de otras empresas que figuran en la lista; y</p>
    <p>Empresas acreditadas en todo el sistema, excepto que soliciten organizaciones sin fines de lucro, centros comerciales de caridad y grupos de recaudación de fondos de caridad que no pueden hacer hipervínculos a nuestro sitio web.</p>
    ...
    <p>sitios de la comunidad .com;</p>
    <p>asociaciones u otros grupos que representan organizaciones benéficas;</p>
    ...
    <p>Si eres una de las organizaciones enumeradas en el párrafo 2 y estás interesada en vincularte a nuestro sitio web, debes informarnos enviando un correo electrónico a Next Generation Teleservices SA de CV. Incluye tu nombre, el nombre de tu organización, la información de contacto, así como la URL de tu sitio, una lista de las URL desde las que tienes la intención de vincular a nuestro sitio web y una lista de las URL de nuestro sitio a las que te gustaría acceder. Espera 2-3 semanas para recibir una respuesta.</p>
    ...
    <p>Mediante el uso del localizador uniforme de recursos al que se está vinculando; o</p>
    ...
    <p>No se permitirá el uso del logotipo de Next Generation Teleservices SA de CV u otro material gráfico para vincular sin un acuerdo de licencia de marca comercial.</p>
    <p>Responsabilidad del contenido:</p>
    ...
    <p>Eliminación de enlaces de nuestro sitio web:</p>
    ...
    <p>Exención de responsabilidad:</p>
    ...
    <p>limitará cualquiera de nuestras responsabilidades o las tuyas de cualquier manera que no esté permitida por la ley aplicable; o</p>
    <p>excluirá cualquiera de nuestras responsabilidades o las tuyas que no puedan estar excluidas según la ley aplicable.</p>
    ...
    <p>Siempre que el sitio web y la información y los servicios en el sitio se proporcionen de forma gratuita, no seremos responsables de ninguna pérdida o daño de cualquier naturaleza.</p></p>
</div>
