<div class="container main">
    <form target="_blank" method="post" class="form form-inline" action="<?php echo site_url("sms/excel"); ?>" >
    <input type="hidden" name="reporte" value="sms_indicador">
        <div class="container">
            <div class="row">
                <div class="col-md-1">
                    <h1>SMS&nbsp;indicadores</h1>
                </div>
...
<script type="text/javascript" src="<?php echo site_url('js/reportes/sms_indi.js?v='.time()); ?>" charset="utf-8"></script>
