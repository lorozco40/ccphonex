...
<a href="config.php?display=languages" class="btn btn-default"><i class="fa fa-list"></i>&nbsp; <?php echo _("List Languages") ?></a>
<a href="config.php?display=languages&view=form" class="btn btn-default" ><i class="fa fa-plus"></i>&nbsp; <?php echo _("Add Language") ?></a>
</div>
<table data-toolbar="#toolbar-langrnav" data-escape="true" data-url="ajax.php?module=languages&amp;command=getJSON&amp;jdata=grid" data-cache="false" data-toggle="table" data-search="true" class="table" id="table-all-side">
    <thead>
        <tr>
