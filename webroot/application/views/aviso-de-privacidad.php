<div class="container main">
    ...
    <p>El sitio web https://assertivebusiness.com/ es propiedad de Next Generation Teleservices SA de CV, que es un controlador de datos de tus datos personales.
    <p>Hemos adoptado esta Política de privacidad, que determina cómo procesamos la información recopilada por https://assertivebusiness.com/, que también proporciona las razones por las que debemos recopilar ciertos datos personales sobre ti. Por lo tanto, debes leer esta Política de privacidad antes de usar el sitio web de https://assertivebusiness.com/.</p>
    ...
    <p>El derecho a la rectificación.</p>
    <p>El derecho a borrar.</p>
    <p>El derecho a restringir el procesamiento.</p>
    <p>El derecho a la portabilidad de datos.</p>
    <p>El derecho a oponerte.</p>
    <p>Derechos en relación con la toma de decisiones automatizada y la elaboración de perfiles.</p>
    ...
    <p>Enlaces a otros sitios web:</p>
    ...
    <p>Si deseas comunicarte con nosotros para comprender más sobre esta Política o deseas comunicarte con nosotros en relación con cualquier asunto sobre los derechos individuales y tu información personal, puedes enviarnos un correo electrónico a ventas@assertivebusiness.com.</p></p>
</div>