...
$set['defaultval'] =& $set['value'];
$set['options'] = '';
$set['name'] = 'Enable Experimental SIPStation PJSIP Mode';
$set['description'] = 'Enables experimental PJSIP mode for SIPStation. This only works on PBX 14 or higher and it will reset any trunk settings you have configured';
$set['emptyok'] = 0;
$set['level'] = 2;
$set['readonly'] = 0;
$set['hidden'] = 0;
