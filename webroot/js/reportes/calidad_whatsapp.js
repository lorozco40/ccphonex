...
function datoscalidad() {
    ...
    $.post(site_url+"calidad/listcalidadwhatsapp", {min: min, max: max, page: pag, tipo: tipo, tipeval: tipeval, agente: estagente }, function(data) {
        ...
        if (!data.data || data.data.length == 0) {
            ...
            html += "<div class='table-row' style='background-color: #2b2b2b; color: #ffffff;'>"+
                ...
                "<div class='table-cell'></div><div class='table-cell'></div><div class='table-cell'>Efectividad en <strong>"+data.cuenta+"</strong> conversaciones</div>";
            ...
            html += "<div class='table-cell'></div><div class='table-cell'></div><div class='table-cell'></div></div>";
