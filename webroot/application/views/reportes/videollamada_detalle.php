<div class="container main">
    <form target="_blank" method="post" class="form form-inline" action="<?php echo site_url("videollamada/excel"); ?>">
        <input type="hidden" name="reporte" value="video_detalle"/>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-1">
                        <h1>Reporte&nbsp;Videollamada&nbsp;detalle</h1>
                    </div>
    ...
    <div class="row">
        <div class="col" id="video_detalle"></div>
    </div><br />
...
<script src="<?php echo site_url('js/reportes/videollamada_detalle.js?v='.time()); ?>" charset="utf-8"></script>
