<div class="container-fluid main">
    <form target="_blank" method="post" class="form form-inline" action="<?php echo site_url("lhc/excel"); ?>">
        <input type="hidden" name="reporte" value="lhc_chats"/>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-1">
                        <h1>Reporte&nbsp;de&nbsp;Chats</h1>
                    </div>
...
<script src="<?php echo site_url('js/reportes/lhc_chats.js?v='.time()); ?>" charset="utf-8"></script>
