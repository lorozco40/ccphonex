	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php } else { ?>
				...
				<?php } else { ?>
					<div class="alert alert-danger text-center" role="alert"><?php echo _("Some checks failed. Please correct the problems in red and make note of the problems in orange below before ugrading")?></div>
				<?php } ?>
		...
		<div class="modal-content">
			...
			<div id="step-1">
				...
				<div class="form-group">
					...
					<select id="pbx_type" name="pbx_type" class="form-control" aria-describedby="helpBlock-pbx_type">
