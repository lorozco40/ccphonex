<div class="container main">
    <form target="_blank" method="post" class="form form-inline" action="<?php echo site_url("facebook/excel"); ?>">
        <input type="hidden" name="reporte" value="facebook_indicador"/>
            <div class="container">
                <div class="row">
                    <div class="col-md-1">
                        <h1>Facebook&nbsp;indicadores</h1>
                    </div>
    ...
    <div class="row">
        <div class="col" id="facebookind"></div>
    </div><br />
...
<script src="<?php echo site_url('js/reportes/facebook_indicador.js?v='.time()); ?>" charset="utf-8"></script>
