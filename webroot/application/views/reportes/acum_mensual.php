<div class="container-fluid main" id="sla">
    <form id="acumform" target="_blank" method="post" class="form form-inline" action="<?php echo site_url("sl/excel"); ?>">
    <input type="hidden" name="reporte" value="acumensual"/>
    ...
    <div class="row">
        <div class="col" id="acumulado"></div>
    </div>
    <div class="row">
        <div class="col" id="leyend"></div>
    </div>
</div>
<script type="text/javascript" src="<?php echo site_url('js/reportes/acum_mensual.js?v='.time()); ?>" charset="utf-8"></script>
